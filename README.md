...
| ----------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Kubernetes**    | Оркестрация контейнеров, DevOps, облака    | Автоматизация развертывания, масштабирования и управления контейнеризованными приложениями. Упрощает DevOps-процессы и обеспечивает отказоустойчивость. |
| **YDB**           | Распределенные базы данных, Big Data       | Горизонтально масштабируемая СУБД от Яндекса с поддержкой ACID. Подходит для высоконагруженных проектов и аналитики.                                    |
| **ElasticSearch** | Поиск, логирование, аналитика данных       | Мощный полнотекстовый поиск и анализ данных в реальном времени. Интеграция с Kibana для визуализации.                                                   |
| **Ceph**          | Распределенное хранилище, облачные решения | Масштабируемое и отказоустойчивое хранилище данных. Экономически эффективная замена традиционным SAN/NAS.                                               |
| **Redis**         | Кэширование, очереди, реальное время       | Высокопроизводительное хранилище ключ-значение in-memory. Поддержка транзакций, pub/sub и Lua-скриптов.                                                 |
