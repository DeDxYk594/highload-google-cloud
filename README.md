...
Загрузка файлов на облако = 39 Мб
...
Для простого хранения всех загруженных файлов требуется 12 экзабайт.
