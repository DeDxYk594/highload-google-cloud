...
В среднем пользователь использует 3 гигабайта для хранения файлов. [^4]
...
[^4]: Результаты опроса, проведённого автором среди 14 человек: https://docs.google.com/spreadsheets/d/1Ivwkm36-tmMWPxk_14mbQxpYs6oTPlgk/edit (дата обращения: 23.02.2025)
