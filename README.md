...
## Обоснования расположения дата-центров (ДЦ) и влияние на продуктовые метрики
...
## Расчёт распределения запросов из секции «Расчёт нагрузки» по типам запросов по дата-центрам
